...
func NewReader2(r io.Reader, b *buffer.Buffer) Reader2 {
	b.Reset()
...
func (r *Reader2) Reset() {
	r.b.Reset()
	r.n = 0
}

func (r *Reader2) Read() (v Value, n int, err error) {
	start := r.n
...
func (r *Reader2) fill(n int) (err error) {
	l := len(r.b.B)
	n -= (l - r.n)
...
func (r *Reader2) fillFromReader(n int) (err error) {
